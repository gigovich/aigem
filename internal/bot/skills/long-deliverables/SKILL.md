...
the requester which form they prefer - inline, file, or wiki - unless they already told you.
Reserve inline for results that genuinely fit in a message.

The saved file holds the deliverable, not the state of work: do not turn it into a status
